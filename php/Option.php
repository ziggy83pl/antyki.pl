...
class Option {
     ...
     * @return mixed[]
     */
    public static function getOptions(int $category_id=0,$controller=''): array{
		$db = \App\Core\App::db();
		$options = [];
		$statement = '';
	...
	public static function getSelectChoices($choices): array{
	...
	public static function checkKind($name): bool{
	...
	public static function getPrice($category_id=0): array{
		$show = false;
	...
	public static function checkShowPrice($category_id=0): bool{
