...
if($admin->is_logged()){
	...
	if(isset($_GET['search'])){
		...
		if(!empty($_GET['awaiting_verification'])){
			if($_GET['awaiting_verification']=='phone'){
				$where_statement .= ' AND phone!="" AND (verified_phone="0" OR verified_phone IS NULL) ';
			}elseif($_GET['awaiting_verification']=='company'){
				$where_statement .= ' AND company_name!="" AND (verified_company="0" OR verified_company IS NULL) ';
			}elseif($_GET['awaiting_verification']=='any'){
				$where_statement .= ' AND ((phone!="" AND (verified_phone="0" OR verified_phone IS NULL)) OR (company_name!="" AND (verified_company="0" OR verified_company IS NULL))) ';
			}
		}
	}
